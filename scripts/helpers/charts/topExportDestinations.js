      ...
      chart = {
        ...
        refresh: function (event, filters) {
          ...
          if(filters.reporter && !filters.commodity && !filters.partner) {
            title = 'Top export destinations of goods from ' + localData.lookup(filters.reporter, 'reporterAreas', 'text') + ' in ' + filters.year;
          ...
          if(filters.reporter && filters.commodity && !filters.partner) {
            title = 'Top export destinations of ' + localData.commodityName(filters.commodity) + ' from ' + localData.lookup(filters.reporter, 'reporterAreas', 'text') + ' in ' + filters.year;
