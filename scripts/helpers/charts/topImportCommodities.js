      ...
      chart = {
        ...
        refresh: function (event, filters) {
          ...
          if(filters.reporter && !filters.commodity && !filters.partner) {
            title = 'Top commodities imported to '+localData.reporterAreas.get(filters.reporter).text+' in '+filters.year;
          }

          // CASE 3: reporter = selected    commodity = null        partner = selected
          if(filters.reporter && !filters.commodity && filters.partner) {
            title = 'Top commodities imported to '+localData.reporterAreas.get(filters.reporter).text+' from '+localData.partnerAreas.get(filters.partner).text+' in '+filters.year+'.';
