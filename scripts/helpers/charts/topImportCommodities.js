          ...
          if(filters.reporter && !filters.commodity && !filters.partner) {
            data.query({
              ...
              $chart
                .slideDown()
                .children('.placeholder')
                .html('Bar chart with top 20 import commodities in '+filters.year+' for '+localData.reporterAreas[filters.reporter]+' from rest of the world.');
            });
            return;
          }
          ...
          if(filters.reporter && !filters.commodity && filters.partner) {
            data.query({
              ...
              $chart
                .slideDown()
                .children('.placeholder')
                .html('Bar chart with top 20 import commodities in '+filters.year+' for '+localData.reporterAreas[filters.reporter]+' from '+localData.partnerAreas[filters.partner]+'.');
            });
            return;
          }
